...
# CORS middleware — allow all origins (Vercel preview URLs are dynamic)
# Must have allow_credentials=False when using "*" per CORS spec, otherwise browser blocks Authorization header
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
